...
const Header = () => {
  ...
  return (
    <header className="shadow-md bg-white tracking-wide z-50 !sticky top-0">
      <section
        ...
        <div className="space-x-4 flex items-center">
          <div className="w-7 h-7 flex items-center justify-center rounded-md text-gray-800 hover:bg-primary hover:text-white transition-all">
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link href={LOGIN_ROUTE}
            className="font-medium text-[15px] border-0 outline-0 cursor-pointer text-primary hover:underline">Login
          </Link>

          <Link href={SIGN_UP_ROUTE} className="w-full bg-gradient-to-tl from-primary via-[#5a00a3] via-[8%] to-black px-4 py-2 text-sm rounded-xs font-medium text-white border border-primary bg-primary hover:bg-primary cursor-pointer">
            Sign up
          </Link>
        ...
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li className="transition-all lg:h-full cursor-pointer place-content-center border-b text-primary border-primary hover:text-white hover:bg-primary hover:rounded-xs py-3 px-3 max-lg:relative"
