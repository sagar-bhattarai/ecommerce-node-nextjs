      ...
      <section
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link href={LOGIN_ROUTE}
            className="font-medium text-[15px] border-0 outline-0 cursor-pointer dark:text-gray hover:underline">Login
          </Link>

          <Link href={SIGN_UP_ROUTE} className="w-full bg-gradient-to-tl  via-[#5a00a3] via-[8%] to-black px-4 py-2 text-sm rounded-xs font-medium dark:text-gray dark:hover:text-white text-white border border-primary bg-primary hover:bg-primary cursor-pointer">
            Sign up
          </Link>
        ...
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li className="transition-all lg:h-full cursor-pointer place-content-center border-b  border-primary  hover:text-white hover:bg-primary hover:rounded-xs py-3 px-3 max-lg:relative"
                onMouseEnter={toggleMegaMenu}
              >Shop
                {toggle &&
                  <div id="mega-menu" className="w-full absolute shadow-lg dark:bg-[#330d57]  bg-white px-6 py-8 top-16 right-0 left-0 z-50">
