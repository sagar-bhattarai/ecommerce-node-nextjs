        ...
        <div className="min-[1200px]:col-span-2 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Electronics</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Home & Living</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Men's Fashion</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Women's Fashion</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 mt-6">
              ...
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Offers</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Skincare</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Health & Hygiene</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 mt-6">
              ...
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Contact Us</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Suggestion</a>
              </li>
              <li>
                <a href='javascript:void(0)' className="hover:text-white text-slate-400 text-sm font-normal">Testinomials</a>
              </li>
            </ul>
          </div>
        </div>
