...
const ProductCard = ({ product }) => {
  // console.log(product)
  return (
    <div className="transition duration-200 hover:bottom-1 relative w-full h-max max-w-[16rem] bg-neutral-primary-soft p-4 border dark:border-gray border-gray-200 rounded-lg shadow-md hover:shadow-lg dark:bg-gray-900 bg-white">
